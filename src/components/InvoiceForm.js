...
class InvoiceForm extends React.Component {
  ...
  handleCalculateTotal = () => {
    ...
    const total = parseFloat(subTotal - discountAmount + parseFloat(taxAmount)).toFixed(2);
            ...
            <Card className="p-4 p-xl-5 my-3 my-xl-4">
              ...
              <Row className="mb-5">
                <Col>
                  ...
                  <Form.Control placeholder={"Who is this invoice to?"} rows={3} value={this.state.billTo} type="text" name="billTo" className="my-2" onChange={this.editField} autoComplete="name" required />
                  ...
                  <Form.Control placeholder={"Billing address"} value={this.state.billToAddress} type="text" name="billToAddress" className="my-2" autoComplete="address" onChange={this.editField} required />
                </Col>
                <Col>
                  <Form.Label className="fw-bold">Bill from:</Form.Label>
                  <Form.Control placeholder={"Who is this invoice from?"} rows={3} value={this.state.billFrom} type="text" name="billFrom" className="my-2" onChange={this.editField} autoComplete="name" required />
                  ...
                  <Form.Control placeholder={"Billing address"} value={this.state.billFromAddress} type="text" name="billFromAddress" className="my-2" autoComplete="address" onChange={this.editField} required />
                </Col>
              </Row>
              <InvoiceItem onItemizedItemEdit={this.onItemizedItemEdit} onRowAdd={this.handleAddEvent} onRowDel={this.handleRowDel} currency={this.state.currency} items={this.state.items} />
          ...
          <Col md={4} lg={3}>
            <div className="sticky-top pt-md-3 pt-xl-4">
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select onChange={e => this.onCurrencyChange({ currency: e.target.value })} className="btn btn-light my-1" aria-label="Change Currency">
              ...
              <Form.Group className="my-3">
                ...
                <InputGroup className="my-1">
                  <Form.Control name="taxRate" type="number" value={this.state.taxRate} onChange={this.editField} min="0.00" step="0.01" max="100.00" />
              ...
              <Form.Group className="my-3">
                ...
                <InputGroup className="my-1">
                  <Form.Control name="discountRate" type="number" value={this.state.discountRate} onChange={this.editField} min="0.00" step="0.01" max="100.00" />
                  <InputGroup.Text>%</InputGroup.Text>
                </InputGroup>
              </Form.Group>
            </div>
